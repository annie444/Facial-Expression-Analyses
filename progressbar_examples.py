...
#                 for i in range(amount) if idx != 0
#             ]
...
def multi_progress_bar_example(left=True):
    ...
    widgets = [
        progressbar.Percentage(),
        ' ',
        progressbar.MultiProgressBar('jobs', markers=markers, fill_left=left),
    ]
...
#     widgets = [
#         'Processed: ',
#         progressbar.Counter('Counter: %(value)05d'), ' lines (',
#         progressbar.Timer(), ')'
#     ]
...
#     with progressbar.ProgressBar(max_value=10,
#                                  term_width=20,
